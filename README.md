...
Actualmente fortalezco mis conocimientos en Security Operations Center (SOC), Blue Team y análisis de malware mediante laboratorios prácticos, con el objetivo de aportar a la protección de infraestructuras tecnológicas y continuar desarrollándome como Analista SOC Junior.
...
- Automatización para SOC con Python
- Integración de YARA y SSDEEP
- Análisis de malware
- Threat Intelligence
